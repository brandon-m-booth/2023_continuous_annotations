...
#dtw_cache_folder_path = sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), os.path.pardir, os.path.pardir, os.path.pardir, os.path.pardir, os.path.pardir, 'results', 'main_study', 'dtw_cache')))
dtw_cache_folder_path = None
...
def ComputePaganAgreement(input_file_path, output_path, do_show_plots=False):
   ...
   if not os.path.isdir(os.path.join(output_path, 'clusters')):
   ...
   for input_file in input_files:
      ...
      for project_entry_name in unique_experiment_names:
         ...
         if dtw_cache_folder_path is not None:
         ...
         output_file_path = os.path.join(os.path.join(output_path, 'clusters'), project_entry_name+'_clusters.csv')
         ...
         if do_show_plots:
            ...
            # Fix for matplotlib 3.6 renaming legend's _ncol to _ncols
            util.TikzplotlibFixNCols(fig_anno)
